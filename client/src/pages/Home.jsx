...
//           Luxury Estste is the Best place to find your next perfect place to
//           live <br />
...
//       {/* <div className="h-[500px]" style={{background: `url(${listing.imageUrls[0]}) center no-repeat`}} key={listing._id}>
